...
Generate a complete self-contained HTML page. ALL CSS must be inline on each element (style="..."). NO <style> or <script> tags. Background #faf8f3 (warm white), body text #1f1d18 (rich dark warm), headings #0a0a0a (deep black), labels Courier New monospace. Max width 480px centered.
...
10. SOURCED QUOTE — font-size 20px italic #0a0a0a, line-height 1.72. Attribution monospace 11px #8a857d uppercase. Real poet, never invented.

11. SENSUAL SECTION — label "Venus in [sign] · [Moon situation]". 3 paragraphs, font-size 17px, line-height 1.82 #1f1d18. One sourced erotic poet quote in em tags (italic #0a0a0a).
