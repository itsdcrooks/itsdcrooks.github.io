...
def pick_images():
    ...
    used += closing
    vedic_imgs = pick(moods=['devotional','contemplative','cosmic'], slot='devotional', exclude=used, n=3)
...
def generate_horoscope(planet_data, images):
    ...
    prompt = f"""You are generating a daily personal horoscope for Daniel — Licensed Professional Counselor Associate, entrepreneur (Inner Space card game, MAFAI AI platform), integrative thinker. Today is {date_str}.
